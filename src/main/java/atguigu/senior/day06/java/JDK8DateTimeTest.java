...
public class JDK8DateTimeTest {
    ...
    public void test1(){
        ...
        LocalDateTime localDateTime4 = localDateTime1.minusDays(3);
        System.out.println(localDateTime1);
...
//        方式一：预定义的标准格式。如：ISO_LOCAL_DATE_TIME;ISO_LOCAL_DATE;ISO_LOCAL_TIME
        ...
        //格式化:日期-->字符串
        LocalDateTime localDateTime = LocalDateTime.now();
        String str1 = timeFormatter.format(localDateTime);
        System.out.println(str1);

        //解析：字符串 -->日期
        TemporalAccessor parse = timeFormatter.parse("2019-02-18T15:42:18.797");
...
//      FormatStyle.FULL / FormatStyle.LONG / FormatStyle.MEDIUM / FormatStyle.SHORT : 适用于LocalDate
        ...
        TemporalAccessor accessor = formatter.parse("2021-01-21 02:32:16");
